...
public class SongsByGenresAdapter extends RecyclerView.Adapter {
    ...
    public SongsByGenresAdapter(Context context, String genres) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new SongsByGenresAdapter.viewHolderArtist(view);
    }
