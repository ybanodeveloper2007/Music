...
public class PopularTracksAdapter extends RecyclerView.Adapter {
    Context context;
    ...
    public PopularTracksAdapter(Context context, List<CategoryInformation> arrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new PopularTracksAdapter.viewHolderArtist(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        try {
            ((PopularTracksAdapter.viewHolderArtist) holder).artistname.setText(arrayList.get(position).getName());
            Picasso.get().load(arrayList.get(position).getImage())
                    .transform(new PicassoHelper.PicassoCircleTransformation()).into(((PopularTracksAdapter.viewHolderArtist) holder).artistlogo);

            ((PopularTracksAdapter.viewHolderArtist) holder).artistlogo.setOnClickListener(new View.OnClickListener() {
